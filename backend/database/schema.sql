...
('Shirt', 'Chemise', 'shirt', 2.50, 4.00, 'Regular shirts', 48, 1),
...
('Suit (Full)', 'Costume Complet', 'suit', 12.00, 20.00, 'Full suit (jacket + pants)', 72, 5),
('Coat/Jacket', 'Manteau', 'coat', 8.00, 14.00, 'Coats, jackets, outerwear', 72, 6),
('Sweater', 'Pull', 'sweater', 4.00, 6.50, 'Sweaters and cardigans', 48, 7),
('Skirt', 'Jupe', 'skirt', 3.00, 5.00, 'Skirts of all lengths', 48, 8),
('Shorts', 'Short', 'shorts', 2.00, 3.50, 'Shorts and bermudas', 48, 9),
('Underwear', 'Sous-vêtements', 'underwear', 1.00, 2.00, 'Undergarments (per piece)', 24, 10),
('Bed Sheets', 'Draps de Lit', 'bedsheet', 5.00, 8.00, 'Bed linens and sheets', 48, 11),
('Towel', 'Serviette', 'towel', 2.00, 3.50, 'Bath and hand towels', 48, 12),
('Curtains', 'Rideaux', 'curtain', 10.00, 16.00, 'Window curtains and drapes', 72, 13),
('Tie', 'Cravate', 'tie', 2.50, 4.00, 'Neckties and bow ties', 24, 14),
('Uniform', 'Uniforme', 'uniform', 12.00, 18.00, 'Work and service uniforms', 72, 15),
('Security Vest', 'Gilet de Sécurité', 'security-vest', 6.00, 10.00, 'High-visibility security vests', 48, 16),
('Blanket', 'Couverture', 'blanket', 8.00, 12.00, 'Standard blankets', 72, 17),
('Pillow', 'Oreiller', 'pillow', 6.00, 9.00, 'Sleeping pillows', 48, 18),
('Women''s Panties', 'Slip Femme', 'panties', 1.50, 2.50, 'Women''s underwear', 24, 19),
('Socks (Pair)', 'Chaussettes', 'socks', 1.00, 2.00, 'Pair of socks', 24, 20),
('Hat/Cap', 'Chapeau/Casquette', 'hat', 4.00, 6.00, 'Hats and caps', 48, 21),
('Tablecloth', 'Nappe', 'tablecloth', 8.00, 12.00, 'Table linens', 72, 22),
('Napkin', 'Serviette de Table', 'napkin', 1.50, 2.50, 'Cloth napkins', 24, 23);
